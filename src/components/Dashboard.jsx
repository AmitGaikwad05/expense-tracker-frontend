...
const Dashboard = () => {
  ...
  // ===================== DASHBOARD =========================
  return (
    <div className="flex w-full h-full overflow-y-scroll bg-gray-50">
      <Sidebar user={user} />
      <div className="flex flex-col w-full min-h-screen">
        ...
        <div className="w-full max-w-7xl mx-auto px-3 md:px-6 py-4 md:py-6 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <NavLink
              to="/earnings"
              className="rounded-2xl p-4 shadow-sm border bg-green-50 text-green-700 hover:shadow-md transition"
            >
              {loadingDashboardStats ? (
                <Loader2 />
              ) : (
            ...
            <NavLink
              to="/expenses"
              className="rounded-2xl p-4 shadow-sm border bg-red-50 text-red-600 hover:shadow-md transition"
            >
              {loadingDashboardStats ? (
                <Loader2 />
              ) : (
            ...
            <div className="rounded-2xl p-4 shadow-sm border bg-green-50 text-green-700 hover:shadow-md transition">
              ...
              <h3 className="text-2xl font-bold">
                {parseInt(totalEarningAmt - totalExpenseAmt)}
              </h3>
              <p className="text-xs text-green-700/80 mt-1">
                Earnings - Expenses
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
            <div className="bg-white rounded-2xl border shadow-sm p-4 lg:col-span-1">
              <div className="flex items-center justify-between mb-3">
                ...
                >
                  <option value="expense" className="text-green-700">
                    Expenses
                  </option>
                  <option value="earning" className="text-red-700">
                    Earnings
                  </option>
                </select>
              </div>
